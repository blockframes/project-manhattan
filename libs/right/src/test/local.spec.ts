...
describe.skip('Distribute income', () => {
  ...
  it('List of 5 incomes', async () => {
    ...
    expect(summary.orgs['Pathé'].total).toBe(3422000);
    expect(summary.orgs['AYD'].total).toBe(1438000);
    expect(summary.orgs['Chaîne TV'].total).toBe(142000);
    expect(summary.orgs['Fonds equity'].total).toBe(45000);
    expect(summary.orgs['Producteur'].total).toBe(502000);
    ...
    expect(summary.orgs['Chaîne TV'].total).toBe(38000);
    expect(summary.orgs['Chaîne TV']['originTv']).toBe(38000);
    expect(summary.orgs['Pathé']['originTheatrical']).toBe(2023000);
    expect(summary.orgs['Pathé']['originTv']).toBe(288000);
    expect(summary.orgs['Pathé']['originVideo']).toBe(243000);
    expect(summary.orgs['Pathé']['originVod']).toBe(151000);
    expect(summary.orgs['Pathé']['rowAllRights']).toBe(446000);
